...
memoria dentro de un marco unificado \cite{blosc2_docs}. Zstd y LZ4 alcanzaron una
...
\cite{ZstdRepo, ZstdSite, LZ4Repo}. zlib conserva valor como referencia estable y madura,
aunque su perfil resulta menos atractivo para una ruta crítica sensible a latencia y acceso
repetido sobre fragmentos del vector de estado \cite{ZlibTechDetails}.
