...
\begin{itemize}
    \item Analizar el impacto del uso de herramientas de compresión de datos sin pérdida de precisión en el consumo de memoria y en el error absoluto y relativo de los resultados respecto a una referencia densa.
