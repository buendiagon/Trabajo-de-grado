...
\begin{itemize}
    ...
    \item Implementar dos algoritmos cuánticos distintos en un simulador cuántico para evaluar el uso de memoria, velocidad y exactitud con y sin compresión de datos.
