...
Las estrategias comprimidas se evaluaron con configuraciones fijas durante toda la evaluación, resumidas en la Tabla~\ref{tab:exp-configs}. Esta decisión se adoptó después de realizar pruebas previas de ajuste y respondió a un criterio de estabilidad metodológica: una vez seleccionadas las configuraciones que ofrecían el mejor compromiso entre memoria y tiempo para los casos de estudio, se conservaron sin cambios en toda la evaluación para evitar que la comparación quedara condicionada por un reajuste específico en cada experimento.
