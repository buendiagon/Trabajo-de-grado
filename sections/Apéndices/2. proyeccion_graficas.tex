...
\(x_0^\top (X^\top X)^{-1}x_0\) refleja que la proyección se vuelve menos precisa a medida
que el punto estimado se aleja de la región en la que se cuenta con mediciones. Por otro, el
