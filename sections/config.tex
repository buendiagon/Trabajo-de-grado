...
% Entradas de la tabla de contenido alineadas a la izquierda (sin tabulado tras el numero)
\makeatletter
\newcommand*\tocnumberline[1]{#1\space}
\newcommand*\tocnumberline@section[1]{#1.\space}
\renewcommand*\l@section[2]{%
  \begingroup
  \let\numberline\tocnumberline@section
...
\renewcommand*\l@subsection[2]{%
  ...
  \@dottedtocline{2}{0em}{0em}{#1}{#2}%
  \endgroup
}
\renewcommand*\l@subsubsection[2]{%
  \begingroup
  \let\numberline\tocnumberline
  \@dottedtocline{3}{0em}{0em}{#1}{#2}%
  \endgroup
}
\makeatother
