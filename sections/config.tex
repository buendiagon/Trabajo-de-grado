...
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{amssymb,amsfonts} % For \mathbb and additional math symbols
\usepackage{physics}          % For \ket, \bra, \braket, \abs, etc.
\usepackage[inkscapeversion=1.0]{svg}  % Suppress Inkscape warning if not installed
\usepackage{multirow}
\usepackage{minted}
...
\usepackage{apacite}
% Define \textcite for apacite compatibility (maps to \citeA)
